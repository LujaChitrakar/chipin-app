...
**Method 1 - Search and send Request:**
- Search and send request to your friends for easy social friend request.

**Method 2 - QR Code (Preferred):**
- Each user has a unique QR code in their profile
- Other users open camera and add friends instantly.
...
**Adding Expenses:**
- After creating a group, you can add friends to your group and start adding expenses and split among the group members.

**Settling Balances:**
- Settle expenses from the group instantly and send/ receive balance from your friends.
...
- Lend money to your friends directly with only few taps.

**Borrowing Money (Request):**
- Request money with your friends directly with only few taps. Receive funds instantly when they approve.
...
- View your unique referral code and QR code and see your current total refereal points. When your friends join the app through your referral code.
