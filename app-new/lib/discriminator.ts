...
const batchExecuteTransactionInstructionDiscriminator = [
  172, 44, 179, 152, 21, 127, 234, 180,
];
const spendingLimitUseInstructionDiscriminator = [
  16, 57, 130, 127, 193, 20, 155, 134,
];
const vaultTransactionExecuteInstructionDiscriminator = [
